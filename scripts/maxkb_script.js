...
<img style="height:100%;width:100%;" src="http://156.238.249.149:8082/chat/MaxKB.gif">
</div>`
...
const initChat=(root)=>{
  ...
  // 添加对话框
  root.insertAdjacentHTML('beforeend',getChatContainerHtml('http','156.238.249.149:8082','dfacb5320257c918','','/chat'))
  // 按钮元素
...
function initMaxkb(){
  ...
  const maxkbId = 'maxkb-'+'01a0ad3a324b7010b01b5f2dca6c148f'
  root.id=maxkbId
